// src/lib.rs
/*
 * Core library for EleventyStatic
 */
...
#[derive(Debug)]
pub struct EleventyStaticProcessor {
    verbose: bool,
    processed_count: usize,
}

impl EleventyStaticProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting EleventyStatic processing");
    
    let mut processor = EleventyStaticProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = EleventyStaticProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = EleventyStaticProcessor::new(false);
